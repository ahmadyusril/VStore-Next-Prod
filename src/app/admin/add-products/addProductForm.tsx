...
const AddProductForm = () => {
  ...
  const addImagesToState = useCallback((value: ImageType) => {
    setImages((prev) => {
      if (!prev) {
        return [value];
      }
  ...
  const removeImagesFromState = useCallback((value: ImageType) => {
    setImages((prev) => {
      if (prev) {
          ...
          {colors.map((item, index) => {
            return (
              <SelectColor
                key={index}
                item={item}
                addImageToState={addImagesToState}
                removeImageFromState={removeImagesFromState}
